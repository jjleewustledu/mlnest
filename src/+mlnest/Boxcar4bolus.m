classdef Boxcar4bolus < handle & mlnest.Boxcar
    %% line1
    %  line2
    %  
    %  Created 27-Dec-2023 23:08:13 by jjlee in repository /Users/jjlee/MATLAB-Drive/mlnest/src/+mlnest.
    ...
    methods
        function this = Boxcar4bolus(varargin)
    ...
    methods (Static)
        function p = prior(~)
            ...
            p(11,:) = {'k11', 'uniform', 1, 2, 'fixed'}; % amplitude
        ...
        function [signal,ideal] = signalmodel(times_sampled, parnames, parvals)
            ...
            A = ks(11);
            qs_ = A*mlnest.Boxcar4bolus.solution(ks, Data); % \in [0,1], 1 Hz sampling
        ...
        function qs = solution(ks, Data)
            ...
            import mlnest.Boxcar4bolus.solution_3bolus;
        ...
        function qs = solution_3bolus(ks, Data)
            ...
            import mlnest.Boxcar4bolus.prior
            import mlnest.Boxcar4bolus.solution_1bolus
            import mlnest.Boxcar4bolus.solution_2bolus
            import mlnest.Artery.slide
