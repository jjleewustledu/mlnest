classdef RadialArtery2bolus < handle & mlnest.RadialArtery
    %% line1
    %  line2
    %  
    %  Created 28-Dec-2023 13:29:09 by jjlee in repository /Users/jjlee/MATLAB-Drive/mlnest/src/+mlnest.
    ...
    methods
        function this = RadialArtery2bolus(varargin)
    ...
    methods (Static)
        function p = prior(~)
            ...
            p(6,:) = {'k6', 'uniform', 0.8, 1.2, 'fixed'}; % amplitude
