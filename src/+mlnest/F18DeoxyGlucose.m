classdef F18DeoxyGlucose < mlnest.AbstractApply
	%% F18DeoxyGlucose implements application ideas from "Data Analysis:  A Bayesian Tutorial, Second Edition"
	...
	methods
        function this = F18DeoxyGlucose(aTsc, aDta, varargin)
